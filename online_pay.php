...
<div class="payment-container">
    ...
    <div class="order-summary">
        ...
        <div class="total-amount">
            Total: $<?php echo number_format($order_data['order_total'], 2); ?>
        </div>
    </div>

    <div class="modal">
        <form class="form" method="POST" action="process_payment.php">
...
<rect fill="white" height="38.1" width="80"></rect>
            ...
            <div class="credit-card-info--form">
                <div class="input_container">
                    ...
                    <input id="card_holder" class="input_field" type="text" name="card_holder" title="Card holder name" placeholder="Enter your full name" required>
                </div>
                <div class="input_container">
            ...
            <input type="hidden" name="amount" value="<?php echo $order_data['order_total']; ?>">
            <button class="purchase--btn" type="submit">Pay $<?php echo number_format($order_data['order_total'], 2); ?></button>
        </form>
    </div>
